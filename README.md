...
QuickDashLauncherは、グローバルホットキー（Alt+Space）でWebサイト、アプリケーション、フォルダ、ファイルに素早くアクセスできるWindows用ランチャーアプリケーションです。

## 主な機能

- 🚀 **グローバルホットキー**: Alt+Spaceでどこからでも即座に起動
