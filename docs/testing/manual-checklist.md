...
15. **ドラッグ&ドロップ登録機能**
    ...
    - 複数ファイルの同時ドロップに対応
    - ブラウザからのURLドラッグ&ドロップに対応（URLをアイテムとして登録）
...
16. **設定メニュー** - ⚙ボタンによる各種操作
    ...
    - ✏️ アイテム管理 - 管理ウィンドウのアイテム管理タブを開く
    - 🗂️ ワークスペースを表示 - ワークスペースウィンドウの表示/非表示を切り替え
    - 🚪 アプリを終了 - アプリケーションの終了
