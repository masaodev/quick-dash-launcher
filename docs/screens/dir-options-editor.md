...
| 項目名 | 入力タイプ | デフォルト | 説明 | 機能詳細 |
|--------|-----------|-----------|------|----------|
| 階層深度 | ドロップダウン | 0 | サブディレクトリの探索深度 | [4.1](#41-階層深度を変更) |
| 取得タイプ | ドロップダウン | both | 取得するアイテムの種類 | [4.2](#42-取得タイプを変更) |
| フィルター | テキスト入力 | なし | ファイル名のフィルターパターン | [4.3](#43-フィルターを入力) |
| 除外パターン | テキスト入力 | なし | 除外するファイル名パターン | [4.4](#44-除外パターンを入力) |
| プレフィックス | テキスト入力 | なし | アイテム名の前に付ける文字列 | [4.5](#45-プレフィックスを入力) |
| サフィックス | テキスト入力 | なし | アイテム名の後に付ける文字列 | [4.6](#46-サフィックスを入力) |
