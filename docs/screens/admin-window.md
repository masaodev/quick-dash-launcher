...
| **基本設定** | ウィンドウ検索ホットキー入力欄 | ウィンドウ検索モード直接起動のホットキー設定 | 基本設定タブ | [4.2](#42-ホットキー入力欄でキー押下) |
...
| `itemSearchHotkey` | `string` | `''` | ウィンドウ検索モード直接起動のホットキー（空=無効） |
...
### 7.5.1. ウィンドウ検索モード直接起動ホットキー

ウィンドウ検索モードで直接起動するためのオプションのホットキー。
