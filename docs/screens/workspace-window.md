...
| 4.7 | グループヘッダー操作 | ヘッダークリック / グループ名ダブルクリック / 右クリックコンテキストメニュー | グループの折りたたみ、編集、色変更、アーカイブ、削除 | [詳細](#47-グループヘッダー操作) |
...
| 4.7.3 | 右クリック→名前を変更 | 右クリック → 名前を変更 | グループ名を編集モードに | [詳細](#473-グループを右クリックして名前を変更) |
| 4.7.4 | 右クリック→色を変更 | 右クリック → 色を変更 | グループの色を変更 | [詳細](#474-グループを右クリックして色を変更) |
| 4.7.5 | 右クリック→アーカイブ | 右クリック → アーカイブ | グループとアイテムをアーカイブに移動 | [詳細](#475-グループを右クリックしてアーカイブ) |
| 4.7.6 | 右クリック→削除 | 右クリック → 削除 | グループを削除（アイテムは未分類に移動） | [詳細](#476-グループを右クリックして削除) |
