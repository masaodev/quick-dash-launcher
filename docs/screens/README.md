...
| **ワークスペースウィンドウ** | Ctrl+W またはシステムトレイメニューから | [workspace-window.md](./workspace-window.md) |
...
| **アプリインポートモーダル** | 管理ウィンドウでアプリインポートボタンクリック時 | （仕様書なし） |
| **バックアップスナップショットモーダル** | 管理ウィンドウでバックアップ操作時 | （仕様書なし） |
| **メモ表示モーダル** | アイテムのメモ表示操作時 | （仕様書なし） |
| **ワークスペースアイテム編集モーダル** | ワークスペースウィンドウでアイテム編集時 | （仕様書なし） |
| **ブックマーク自動インポートルールモーダル** | ブックマークインポートモーダルでルール設定時 | （仕様書なし） |
...
| **URLコンバーターメニュー** | URLの変換・加工操作メニュー | （仕様書なし） |
...
| **クリップボードアイテムエディター** | クリップボードアイテムの編集 | （仕様書なし） |
| **カラーピッカー** | カラー選択コンポーネント | （仕様書なし） |
