...
| **アイテム管理** | タブ選択ドロップダウン | 編集対象のタブを選択 | アイテム管理タブ | [4.26](#426-タブ選択ドロップダウンを変更) |
| **アイテム管理** | ファイル選択ドロップダウン | 編集対象のファイルを選択（複数ファイルタブの場合のみ表示） | アイテム管理タブ、複数ファイルタブ選択時 | [4.27](#427-ファイル選択ドロップダウンを変更) |
...
| 4.26 | タブ選択ドロップダウンを変更 | ドロップダウン選択 | 編集対象のタブを切り替え | [詳細](#426-タブ選択ドロップダウンを変更) |
| 4.27 | ファイル選択ドロップダウンを変更 | ドロップダウン選択 | 編集対象のファイルを切り替え（複数ファイルタブの場合のみ） | [詳細](#427-ファイル選択ドロップダウンを変更) |
...
3. 選択したタブのdefaultFileまたは最初のファイルが自動的に選択される
4. 選択したファイルの内容をテーブルに表示

#### 利用可能なタブ
- `settings.json`の`dataFileTabs`配列に登録されているタブのみが選択肢に表示されます
- tempdata.txtは除外（自動生成ファイルのため）

#### 初期選択
- アイテム管理タブを開いた際は、`dataFileTabs`配列の最初のタブが初期選択される
...
#### 自動選択
- タブ変更時に、そのタブのdefaultFileまたは最初のファイルが自動的に選択されます
