...
- **右クリック → 名前を変更**: コンテキストメニューから編集モードに入る
...
2. アーカイブされたグループのコンテキストメニューから「ワークスペースに移動」を選択
3. グループとアイテムがワークスペースに復元される
...
1. ワークスペースウィンドウで「📦」タブをクリック
2. アーカイブされたグループの「削除」ボタンをクリック
3. 確認ダイアログで削除を確定
4. グループとアイテムがアーカイブから完全に削除される
